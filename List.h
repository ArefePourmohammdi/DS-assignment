...
//	int capacity;                      // Actual maximum capacity of data structure
    Patient* head;                     // List is actually a linked list and it is its head
    Patient* SaveParent;               // After searching we save parent of new node in this pointer and than use it when we want
                                       // to insert a new node we use this parent.
